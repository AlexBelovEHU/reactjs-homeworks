      ...
      <div className={styles.navigationContainer}>
        ...
        <div className={styles.navigationRight}>
          ...
          <button
            ...
            aria-label={
              isUsingSystemTheme
                ? `Theme follows system preference. Switch to ${nextTheme} theme.`
                : `Switch to ${nextTheme} theme.`
            }
            aria-pressed={theme === 'dark'}
          >
            <span className={styles.themeToggleLabel}>Theme</span>
            <span className={styles.themeToggleValue}>{theme === 'dark' ? 'Dark' : 'Light'}</span>
            {isUsingSystemTheme ? <span className={styles.themeToggleBadge}>Auto</span> : null}
          </button>
