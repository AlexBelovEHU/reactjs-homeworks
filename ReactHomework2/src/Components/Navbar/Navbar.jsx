      ...
      <div className={styles.navigationContainer}>
        ...
        <div className={styles.navigationRight}>
          ...
          <nav role="navigation" className={styles.navMenu}>
            ...
            <a href="/order" className={styles.navLink}>
              Order
            </a>
          ...
          <div className={styles.cartWrapper}>
            <a href="#" className={styles.cartButton} role="button" aria-haspopup="dialog" aria-label="Open cart">
              <svg
              ...
              <div className={styles.cartQuantity}>0</div>
            </a>
          </div>
        </div>
      </div>
