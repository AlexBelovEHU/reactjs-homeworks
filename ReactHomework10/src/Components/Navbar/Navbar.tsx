    ...
    <header className={styles.navbar} id="Navigation" role="banner" data-animation="default" data-duration="400">
      <div className={styles.navigationContainer}>
        ...
        <div className={styles.navigationRight}>
          <button className={styles.menuButton} aria-label={copy.nav.toggleMenu}>
          ...
          <div className={styles.cartWrapper}>
            <Link to="/order" className={styles.cartButton} role="button" aria-haspopup="dialog" aria-label={copy.nav.openCart}>
              <svg
